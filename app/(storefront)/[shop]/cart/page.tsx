                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2 mb-2">
                        <div className="flex-1 min-w-0">
                          ...
                          {item.variant && (
                            <div className="text-xs sm:text-sm text-gray-600 mt-0.5">{item.variant.name}</div>
                          )}
                        </div>
                      ...
                      <div className="flex items-center justify-between gap-3">
                        {/* Price */}
                        <div className="text-sm sm:text-base font-semibold" style={{ color: 'var(--theme-primary)' }}>
