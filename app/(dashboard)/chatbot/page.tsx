...
export default function Chatbot(){
  ...
  const handleTrain = async () => {
    ...
    try {
      ...
      // In a real implementation, this would send training data to the AI service
          ...
          <div className="card-pad">
            ...
            <div className="mt-2 grid gap-2">
              {["Facebook Page", "Instagram DM", "WhatsApp"].map(channel => (
                <div key={channel} className="flex items-center justify-between rounded-xl border p-3">
