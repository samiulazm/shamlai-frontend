...
export default function IncreaseStock() {
  ...
  return (
    <div className="grid gap-6 max-w-4xl">
      <div>
        <h1 className="text-2xl font-bold">Increase Stock</h1>
        <p className="text-gray-500 text-sm mt-1">Add inventory to products</p>
      </div>
          ...
          <div>
            ...
            {selectedProductData && (
              <p className="text-sm text-gray-500 mt-1">
                New stock will be: {(selectedProductData.inventory_quantity || 0) + quantity}
              </p>
            )}
          </div>
