  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data?.user) {
        ...
        if (profileError) {
          logger.warn('Profile setup error', profileError instanceof Error ? profileError : new Error(String(profileError)));
        }
        ...
        try {
          ...
          logger.warn('Shop settings error', shopError instanceof Error ? shopError : new Error(String(shopError)));
